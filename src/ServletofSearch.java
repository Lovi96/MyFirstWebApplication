...
public class ServletofSearch extends javax.servlet.http.HttpServlet {
	...
	private void navbarBuilder(javax.servlet.http.HttpServletResponse response) throws IOException {
		...
		writer.print("</head><body><div class=\"bg\"></div><header class=\"navbar\" role=\"banner\">\n" +
				"    <div class=\"container\">\n" +
				"        <div class=\"jumbotron\" id=\"bannerHeader\">\n" +
				"            <h1 style=\"text-align: center; color:#FFFFFF\"><u>Airplanes!</u></h1>\n" +
				"            <p style=\"text-align: center; color:#FFFFFF\">Everything about aviation in one place.</p>\n" +
				"        </div>\n" +
		...
		writer.print("<li class=\"menuItemCustom\"><a href=\"index.html\">Home</a></li>\n" +
				"                        <li class=\"menuItemCustom\"><a href=\"#\">More about aviation</a></li>\n" +
				"                        <li class=\"menuItemCustom\"><a href=\"#\">Encyclopedia of planes</a></li>\n" +
				"                        <li class=\"menuItemCustom active\"><a href=\"/ServletofSearch\">TweetCool</a></li>\n" +
	...
	private void bodyBuilder(javax.servlet.http.HttpServletResponse response) throws IOException {
		...
		//METHOD1 getting filepath from relative path. REALLY SLOW!!!
		//String relativePath = "tweets.txt";
		//InputStream inputStream = getServletContext().getResourceAsStream(relativePath);
		//BufferedReader br = new BufferedReader(new InputStreamReader(inputStream, "UTF8"));
		//METHOD2 giving filepath beforehand, fast but unreliable on linux
		boolean wasUser = false;
		PrintWriter writer = response.getWriter();
		BufferedReader br = new BufferedReader(new FileReader("D:\\Programok\\apache-tomcat-8.5.12\\webapps\\ROOT\\tweets.txt"));
		String currentLine = "";
	...
	private void writeToFile(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws IOException, javax.servlet.ServletException {
		...
		if(feedBack.equals("") || feedBack.equals(" ")) {
			...
			//METHOD1: getting filepath from relative path, SLOW!!!
